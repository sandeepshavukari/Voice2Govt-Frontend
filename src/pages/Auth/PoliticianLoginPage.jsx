        ...
        try {
            ...
            if (politicianDto && politicianDto.polUsername) {
                const loggedInUser = {
                    ...
                    firstName: politicianDto.pol_firstName,
                    lastName: politicianDto.pol_lastName,
                    id: politicianDto.pol_id,
                    pol_id: politicianDto.pol_id // Store pol_id specifically for politician
                };
    ...
    return (
        <Paper elevation={6} sx={{ maxWidth: 450, mx: 'auto', p: 4, borderRadius: 2 }}>
            ...
            <Typography variant="body2" align="center" sx={{ mt: 3 }}>
                Don't have an account? <Link to="/politician/register" style={{ textDecoration: 'none', color: theme => theme.palette.primary.main, fontWeight: 'medium' }}>Register here</Link>
            </Typography>
        </Paper>
    );
}
